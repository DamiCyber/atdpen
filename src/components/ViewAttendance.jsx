...
import "../assets/style/viewattendance.css";
      ...
      <div className={`main-content ${isSidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`}>
        <div className="header">
          ...
          <form className="search-form">
            ...
            <input className="search-input" placeholder="Type your text" required type="text" />
              ...
              {attendanceSettings ? (
                <>
                  <div className="setting-item">
                    ...
                    <span className="value">{attendanceSettings.start_time || "N/A"}</span>
                  </div>
                  <div className="setting-item">
                    <span className="label">End Time</span>
                    <span className="value">{attendanceSettings.end_time || "N/A"}</span>
                  </div>
                </>
              ) : (
